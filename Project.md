...
- **Data Preprocessing:** It is not that hard to extract financial data from [Tiingo](https://www.tiingo.com/). However, 80% of a machine learning project is all about
