...
I found that LDA was a good fit for my data and its assumptions are based on naive Bayesian methods and LDA gave a great result. Therefore, I have confidence that Bayesian methods will perform well, too.
At last, I have to clarify that ANN is not a good fit for my data. But I will try to search for more observations to expand my dataset and tune the hyperparameters by a grid search to make ANN perform better.
